...
static void hci_cmd_send_ble_set_adv_data(void)
{
    ...
    char *sBeaconDat  = "t.co/Wq5PdlPc8Y";
    ...
    adv_data[7] = 0;     // Length of Beacon Data
    ...
    */
    int iBeconLen = (uint8_t)strlen(sBeaconDat);
    adv_data[7]=6+ iBeconLen;
    for (int i = 0; i < iBeconLen; i++) {
        adv_data[14 + i] = (uint8_t)sBeaconDat[i];
        printf("i=%d, 0x%02x\n" ,i , adv_data[14 + i]);
    }
    
    adv_data_len = 14+ iBeconLen;
